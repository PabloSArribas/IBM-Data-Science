...
if __name__ == '__main__':
    # Detect if running in IBM Labs (special environment variable is set)
    if "SN_ENV" in os.environ or "VSCODE_PID" in os.environ:
        app.run()  # IBM Labs or hosted notebook environment
    else:
        app.run_server(debug=True)  # Local environment
